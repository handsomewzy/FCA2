...
if __name__ == '__main__':
    test('/data1/userhome/luwen/Code/wzy/Vid4/diffusion_sr/calendar/00000000.png_0.png', '/data1/userhome/luwen/Code/wzy/Vid4/GT/calendar/00000000.png', crop_border=4, test_y_channel=False)
    test('/data1/userhome/luwen/Code/wzy/Vid4/diffusion_sr/calendar/00000000.png_0.png', '/data1/userhome/luwen/Code/wzy/Vid4/GT/calendar/00000000.png', crop_border=4, test_y_channel=True)

    test('/data1/userhome/luwen/Code/wzy/CAD2VSR/results/Vid4_meta/visualization/Vid4_crf15/calendar/00000000_Vid4_meta.png', '/data1/userhome/luwen/Code/wzy/Vid4/GT/calendar/00000000.png', crop_border=4, test_y_channel=False)
    test('/data1/userhome/luwen/Code/wzy/CAD2VSR/results/Vid4_meta/visualization/Vid4_crf15/calendar/00000000_Vid4_meta.png', '/data1/userhome/luwen/Code/wzy/Vid4/GT/calendar/00000000.png', crop_border=4, test_y_channel=True)
