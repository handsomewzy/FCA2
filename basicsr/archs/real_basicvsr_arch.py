...
from .basicvsr_arch import ResidualBlocksWithInputConv, SPyNet, BasicVSRNet
...
@ARCH_REGISTRY.register()
class RealBasicVSRNet_GAE(BaseModule):
    """RealBasicVSR network structure for real-world video super-resolution.
    ...
    def forward(self, lqs, return_lqs=False):
        ...
        for lqs in lqs_sublist:
            _outputs = self.basicvsr(lqs)
